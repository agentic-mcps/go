...
func TestRuleSet(t *testing.T) {
	want := []string{
		"errors-01", "errors-04", "errors-09", "errors-13", "errors-14", "errors-17", "errors-19",
	}
	if got := astutil.RulesInDomain("errors"); !slices.Equal(got, want) {
		t.Fatalf("registered rules = %v, want %v", got, want)
	}
	disabled := []string{
		"errors-02", "errors-03", "errors-05", "errors-06", "errors-07",
		"errors-10", "errors-11", "errors-12", "errors-15", "errors-16",
	}
