...
func TestDeclarationShapeTracksExportedSurface(t *testing.T) {
	tests := []struct {
		...
		{name: "inferred variable value", declaration: verification.ChangedDeclaration{Kind: "variable", Name: "Value", Change: verification.ChangeModified}, base: "var Value = 1", current: "var Value = 2"},
